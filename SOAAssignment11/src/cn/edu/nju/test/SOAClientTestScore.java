...
import cn.edu.nju.score_manage.个人信息类型;
import cn.edu.nju.score_manage.地址类型;
import cn.edu.nju.score_manage.学生信息;
import cn.edu.nju.score_manage.成绩性质类型;
import cn.edu.nju.score_manage.成绩类型;
import cn.edu.nju.score_manage.课程成绩列表类型;
import cn.edu.nju.score_manage.课程成绩类型;
import cn.edu.nju.score_manage.部门属性类型;
import cn.edu.nju.score_manage.部门类型;
...
public class SOAClientTestScore {
	...
	public void init() {
		...
		chengjis.add(new 成绩类型("141250301", 100));
		type.set成绩(chengjis);
		list2.add(type);
		list.set课程成绩(list2);
